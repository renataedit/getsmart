        ...
        <div class="row">
            <div class="col-xs-12 col-md-6">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6"><h4>6722, Szeged, Tisza Lajos krt. 63, 1. em.</h4></div>
                    <div class="col-xs-12"><?= do_shortcode('[mappress mapid="1"]') ?></div>
                </div>
            </div>
            <div class="col-xs-12 col-md-6 kotelezo-elemek">
                <a href="<?php bloginfo('url'); ?>/viselheto-bioszenzortechnologia-alkalmazasa-a-gyogyszerkutatasban-valamint-a-kozossegi-stresszmeresben/<?= ICL_LANGUAGE_CODE == 'hu' ? '' : '/?lang=en' ?>" class="szechenyi">
